...
let futbolStadium = true;
//console.log(city, country, population, futbolStadium);
//console.log(typeof city,typeof country,typeof population,typeof futbolStadium );
...
const s1 = time * speedOfFirst;
const s2 = time * speedOfSecond;
const s = s1 + s2;
console.log(s);
*/
